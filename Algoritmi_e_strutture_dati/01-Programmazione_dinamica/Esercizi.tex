...
\section*{Il problema del commesso viaggiatore}
    ...
    \paragraph{Obiettivo} Trovare il numero massimo di vacanze che il viaggiatore può fare con il suo budget limitato.
    \paragraph{Spunto} Cosa cambierebbe se il viaggiatore è disposto a viaggiare nelle stesse città? E se qualche vacanza fosse considerabile migliore delle altre? qualche suo amico lo prenderà in giro per aver visitato Lonigo?

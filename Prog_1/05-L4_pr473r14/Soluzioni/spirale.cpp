...
int quadrato(int N, int col, int start = 0){
    if(col == 1){
...
int main(){
    ...
    cout<<"Inserisci dimensione della spirale: ";
    cin>>n;
    cout<<"Inserisci colonna da sommare (da 1 a N estremi inclusi): ";
    cin>>col;

    cout<<"Risultato: "<<quadrato(n,col)<<endl;
